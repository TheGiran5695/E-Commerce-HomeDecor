...
@Component({
  selector: 'app-bed-collection',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule],
  templateUrl: './bed-collection.component.html',
  styleUrl: './bed-collection.component.css'
})
export class BedCollectionComponent implements OnInit{
  ...
  applyFilters():void {
    ...
    this.filteredProducts = this.products.filter((product: { category: string }) => {
      return product.category === 'Bed'; // Only include products with category "Beds"
    });
  }
